...
const HomeAbout = () => {
  return (
    <section className="homeAbout bg-[#E3D5C3] py-16 px-6">
      <div className="homeAboutContentContainer max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-4 gap-8 items-center">
        ...
        <div className="homeAboutContent col-span-1 lg:col-span-2 space-y-8 lg:pl-10 text-[#2A2725]">
          <div className="space-y-4">
            <span className="block text-[#C86632] text-2xl font-bold italic">Our Story</span>
            <h2 className="text-4xl font-bold tracking-tight text-[#2A2725]">The Heart of Nona’s Kitchen</h2>
          </div>

          <p className="text-base leading-relaxed text-[#2A2725]/90 max-w-2xl">
          ...
          <p className="text-sm italic leading-relaxed text-[#2A2725]/80 max-w-2xl">
          ...
          <div>
            <a href="/menu" className="inline-flex items-center gap-2 rounded-full border-2 border-[#2A2725] bg-transparent px-6 py-3.5 font-semibold text-[#2A2725] transition scale-90 hover:scale-100 hover:bg-[#2A2725] hover:text-[#E3D5C3]">
              <span>Our Story</span>
            </a>
          </div>
        </div>
